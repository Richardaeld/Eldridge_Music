...
music selection to include other books than just Piano, however it might be some time until we make it that far. Until then, please spend a moment 
...
+ As a shopper I want to view all the items in my cart.
    + I have been shopping and need to know how much money I am spending on my selected merchandise. I click on a **cart** button in the top right corner 
...
+ As a shopper I want to be able to search for an item by name or composer.
    ...
    taken to a page containing all the books composed by this composer.
+ As a shopper I want to be sent a confirmation email after I checkout.
    + As I am finishing shopping I click the, **Go to secure checkout** button and I am taken to a from I must fill inorder to check out. I finish 
    form and after I submit it I am sent an email with detailed information about my invoice.

+ As a returning user I would like a create an account.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page. A drop down menu 
    appears below the **profile** button and I am able to click, **Create Account**. I am taken to a page where I can start the process to create an account.
+ As a returning user I would like a confirmation email after registering.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page. A drop down menu 
    appears below the **profile** button and I am able to click, **Create Account**. I am taken to a page where I can start the process to create an 
    acoount and when I finish I am sent a confirmation email.
+ As a returning user I would like to easily login or logout.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page. A drop down menu
    appears below the **profile** button and I am able to click, **Login**. I am taken to a page and asked to login.
+ As a returning user I would like to recover my forgotten passord.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page.  A drop down menu
    appears below the **profile** button and I am able to click, **Login**. I am taken to the login page and I click a button **Forgot Password?** and I 
    am taken to a password reset page.
+ As a returning user I would like to have a personalized **profile** that has all my previous invoice information.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page. A drop down menu
    appears below the **profile** button and I am able to click, **Login**. I am taken to a page where I login. When Im finished logging in, I click 
    on the **profile** button on the top right corner of the page. A drop down menuappears below the **profile** button and I am able to click **profile**. 
    Once on the **profile** page I can clearly see all of my previous Invoices.
+ As a returning user I would like to update my shipping information.
    + I opened the home page of Eldridge Music Book Emporium. I click on the **profile** button on the top right corner of the page. A drop down menu
    appears below the **profile** button and I am able to click, 'Login'. I am taken to a page where I login. When I'm finished logging in, I click on 
    the **profile** button on the top right corner of the page. A drop down menuappears below the **profile** button and I am able to click **profile**. 
    Once on the **profile** page I can clearly see all of my shipping information. I update my shipping information and submit the changes.
