    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_full_name', models.CharField(blank=True, max_length=75, null=True)),
                ('default_prefered_name', models.CharField(blank=True, max_length=50, null=True)),
                ('default_pronouns', models.CharField(blank=True, max_length=10, null=True)),
